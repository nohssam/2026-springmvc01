...
<body>
<div id="bbs">
  <form method="post" encType="multipart/form-data"  action="${pageContext.request.contextPath}/board/answriteok">
    <table>
      <caption>Board 댓글 글쓰기</caption>
      <tbody>
      <tr>
        <th>제목:</th>
      ...
      <tr>
        <th>내용:</th>
        <td><textarea name="content" cols="50" rows="8" required></textarea></td>
      </tr>
      <tr>
        <th>첨부파일:</th>
