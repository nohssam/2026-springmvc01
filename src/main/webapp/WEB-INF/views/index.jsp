...
<%-- <p><button onclick="send_weather()">기상청 단기 예보(공공데이터)</button><p>--%>
 ...
 <p><button onclick="send_cultural()">서울시 문화 행사 / 한국음식점(서울 포털)</button><p>
<script>
    function send_go(){
    ...
    function send_weather_json() {
     location.href=`${pageContext.request.contextPath}/weatherJsonForm`;
    }
    function send_weather_xml() {
     location.href=`${pageContext.request.contextPath}/weatherXmlForm`;
    }
